...
function actionSelect(strAction, index) {
  ...
  switch (strAction) {
    ...
    case "flight":
      ...
      intDays = calcTimeTakenToTravel(calcDistance(JSONdestinations["destinations"][JSONlocation["location"][0].locationCurrent].latitude, JSONdestinations["destinations"][JSONlocation["location"][0].locationCurrent].longitude, JSONdestinations["destinations"][JSONlocation["location"][0].locationDestination].latitude, JSONdestinations["destinations"][JSONlocation["location"][0].locationDestination].longitude), JSONconfig["config"][0].units);
      intMoney = calcDistanceCost(calcDistance(JSONdestinations["destinations"][JSONlocation["location"][0].locationCurrent].latitude, JSONdestinations["destinations"][JSONlocation["location"][0].locationCurrent].longitude, JSONdestinations["destinations"][JSONlocation["location"][0].locationDestination].latitude, JSONdestinations["destinations"][JSONlocation["location"][0].locationDestination].longitude, JSONconfig["config"][0].units), JSONconfig["config"][0].units);
    ...
    case "trek":
      ...
      intDays = calcTimeTakenToTravel(calcDistance(JSONdestinations["destinations"][JSONlocation["location"][0].locationCurrent].latitude, JSONdestinations["destinations"][JSONlocation["location"][0].locationCurrent].longitude, JSONdestinations["destinations"][actionSelectIndex].latitude, JSONdestinations["destinations"][actionSelectIndex].longitude), JSONconfig["config"][0].units);
      intMoney = calcDistanceCost(calcDistance(JSONdestinations["destinations"][JSONlocation["location"][0].locationCurrent].latitude, JSONdestinations["destinations"][JSONlocation["location"][0].locationCurrent].longitude, JSONdestinations["destinations"][actionSelectIndex].latitude, JSONdestinations["destinations"][actionSelectIndex].longitude, JSONconfig["config"][0].units), JSONconfig["config"][0].units);
