...
function destCreateStats() {
  ...
  for (d in JSONdestination) {
    ...
    intDistance = travCalcDistance(JSONconfig[0].homeLatitude, JSONconfig[0].homeLongitude, JSONdestination[d].latitude, JSONdestination[d].longitude, JSONgame[0].measure);
    ...
    JSONdestination[d].description = "A " + intDays + " day holiday";
